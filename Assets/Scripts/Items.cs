    ...
    AllItemsList = new List<Item>
        {
            ...
            new Item(3, "Spear", "A common polearm for slashing enemies. (Common/green)", 0, 25, 0, 0),
            ...
            new Item(7, "Greatsword", "An uncommon spear infused with enchantments. (Uncommon/Blue)", 0, 45, 5, 0),
            new Item(8, "Orc Warhammer", "An uncommon warhammer blessed with holy power. (Uncommon/Blue)", 100, 50, 10, 0),
            new Item(9, "Radic's Yatagan", "A legendary spear empowered by celestial forces. (Legendary/purple)", 50, 75, 10, 0),
